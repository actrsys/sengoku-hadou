 ...
 * 修正: 複数部隊（最大5部隊vs5部隊）の配置・ターン管理・ZOC対応
 */
...
class FieldWarManager {
    ...
    updateMap() {
        ...
        if (this.state === 'MOVE_PREVIEW' && this.previewTarget && unit) {
            ...
            pEl.innerText = unit.isGeneral ? '大' : '凸';
    ...
    endFieldWar(resultType) {
        ...
        this.warState.defender.rice = this.defRice;
