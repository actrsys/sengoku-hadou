...
window.GameEvents.push({
    ...
    checkCondition: function(game, context) {
        ...
        if (game.flags && game.flags.shogunProtectionDone) return false;
    ...
    execute: async function(game, context) {
        ...
        game.flags.shogunProtectionDone = true;
        ...
        if (nobunaga && nobunaga.isDaimyo && nobunaga.clan !== 0 && nobunaga.clan !== killerClanId) {
            ...
            const isOkehazamaDone = game.flags && game.flags.okehazama3Done;
