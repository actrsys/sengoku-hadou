...
const APTITUDE_DESCRIPTIONS = {
    // 足軽
    [APTITUDE_NAMES.ASHIGARU]: "足軽隊の近接戦闘時の与ダメージ上昇と被ダメージ軽減に影響する。レベルが高いほど効果が大きい。",
    // 馬術
    ...
    // 武芸
    [APTITUDE_NAMES.BUGEI]: "所在拠点への計略成功率低下、訓練効果上昇、戦死率軽減、火計防御に影響する。",
    // 忍術
    [APTITUDE_NAMES.NINJUTSU]: "破壊工作・民心撹乱の成功率と効果上昇、山岳・森・川の移動コスト軽減、火計成功率上昇に影響する。",
    // 操船
...
const SKILL_DESCRIPTIONS = {
    // ----- ダメージ系 -----
    // 猛将
    [SKILL_NAMES.MOUSHO]: "①自部隊は一定確率でクリティカルが発生するようになる。（野戦）",
    // 鬼
    [SKILL_NAMES.ONI]: "①自部隊は一定確率でクリティカルが発生するようになる。（野戦）\n②クリティカル発生時に与えるダメージが１．５倍になる。（野戦）",
    // 狙撃
    [SKILL_NAMES.SOGEKI]: "①自部隊は遠距離攻撃時に一定確率でクリティカルが発生するようになる。（野戦：鉄砲）",
    // 朱槍
    [SKILL_NAMES.SHUYARI]: "①隣接戦闘時に与えるダメージが１０％上昇する。（野戦）\n②自部隊は隣接戦闘時に一定確率でクリティカルが発生するようになる。（野戦：足軽・騎馬）",
    // 傾奇者
    [SKILL_NAMES.KABUKIMONO]: "①自軍が追い詰められていて自部隊の兵数が少ない時、自部隊が与えるダメージが激増し、受けるダメージが激減する。（野戦：足軽・騎馬）",
    // 赤備え
    [SKILL_NAMES.AKAZONAE]: "①自部隊が受けるダメージが１０％減少する。（野戦／攻城戦）\n②ターン経過による士気の低下を無効化する。（野戦／攻城戦）",
    // 甲斐の虎
    [SKILL_NAMES.KAI_NO_TORA]: "①自身が参戦している時、自勢力の部隊全てが与えるダメージが５％上昇し、受けるダメージが１０％減少する。（野戦／攻城戦）\n②自部隊は一定確率でクリティカルが発生するようになる。（野戦）",
    // 越後の龍
    ...
    // 退き巧者
    [SKILL_NAMES.RETREAT]: "①側面および背面から受けるダメージ補正を無効化する。（野戦）\n②敵部隊と隣接している状態から離脱しやすくなる。（野戦）\n③撤退時の負傷兵の回復率が上昇する。（野戦／攻城戦）",
    // 天下布武
    [SKILL_NAMES.TENKA_FUBU]: "①自部隊は一定確率でクリティカルが発生するようになる。（野戦）\n②悪天巧者・踏破・退き巧者の効果を併せ持つ。",
    
    // ----- 計略・外交系 -----
    // 謀将 ※内部的に謀将が大名や国主である時のみ、暗殺を図るようになる
    [SKILL_NAMES.BOSHO]: "①自身が大名、国主または暗殺の担当者である時、暗殺の基本成功率が５％上昇する。",
    // 謀神
    [SKILL_NAMES.BOSHIN]: "①自部隊が行う火計の成功率が１５％、挑発の成功率が５％上昇する。（攻城戦）\n②自身が大名、国主または暗殺の担当者である時、暗殺の基本成功率が８％上昇する。\n③自身が大名、国主または計略の担当者である時、破壊工作・民心撹乱の成功率が１０％上昇する。",
    // 奥羽の驍将
    [SKILL_NAMES.OU_NO_GYOSHO]: "①自部隊と戦闘する相手部隊のクリティカル発生を無効化する。（野戦）\n②自身が大名、国主または暗殺の担当者である時、暗殺の基本成功率が８％上昇する。\n③自身が大名、国主または外交の使者である時、親善・同盟の成功率が１０％上昇する。",
    // 表裏比興
    [SKILL_NAMES.HYORIHIKYO]: "①自身が大名または外交の使者である時、親善の成功率が１５％上昇する。\n②自身が大名または外交の使者である時、断交時のペナルティが減少する。\n③自身が大名である時、主家からの援軍要請を拒否できる。",
