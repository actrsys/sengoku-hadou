...
window.EventTextManager = {
    ...
    okehazama_imagawa_part1: function(args) {
        return [
            ...
            { type: 'dialog', leftName: args.yoshimotoName, leftFace: args.yoshimotoFace, msg: `「相手はあの${args.nobuhideName}の子じゃ」` },
            { type: 'dialog', leftName: args.yoshimotoName, leftFace: args.yoshimotoFace, msg: `「あれの恐ろしさは皆が一番よく知っておろう？」` },
            { type: 'dialog', leftName: args.juushinFName, leftFace: args.juushinFFace, msg: `「もはや${args.owariProvinceShort}に虎はおりませぬ」` },
            { type: 'dialog', leftName: args.juushinFName, leftFace: args.juushinFFace, msg: `「${args.nobunagaGivenName}はうつけとの噂。気にするほどの男ではございませぬ」` },
    ...
    kawanakajima_event: function(args) {
        return [
            ...
            { type: 'dialog', leftName: args.kenshinName, leftFace: args.kenshinFace, msg: `「${args.kagemochiTitle}に兵一千を預ける。これをもって${args.takedaFamilyName}軍の別働隊に備え、渡河を阻止されたし」` },
    ...
    eiroku_no_hen_part1: function(args) {
        return [
            ...
            { type: 'dialog', leftName: args.tomomichiName, leftFace: args.tomomichiFace, msg: `「それよ。多方に手を回しておるようじゃが……」` },
            { type: 'dialog', leftName: args.masakatsuName, leftFace: args.masakatsuFace, msg: `「何も言えぬよ。我らとしても、公方様が相手となっては臣下の礼を取らざるをえまい」` },
            { type: 'dialog', leftName: args.nagayasuName, leftFace: args.nagayasuFace, msg: `「ふん、将軍など今の世となっては何の役にも立たぬわ」` },
            { type: 'dialog', leftName: args.nagayasuName, leftFace: args.nagayasuFace, msg: `「あれは身の程を理解しておらぬ。あれこれ口出しをしてきおって、目障りなことこの上ないわい」` },
            { type: 'dialog', leftName: args.masakatsuName, leftFace: args.masakatsuFace, msg: `「……先が見えすぎるというのも考えものじゃな」` },
            { type: 'dialog', leftName: args.masakatsuName, leftFace: args.masakatsuFace, msg: `「おぬしらが思っておるほど、幕府の権威は落ちてはおらぬぞ」` },
            { type: 'dialog', leftName: args.tomomichiName, leftFace: args.tomomichiFace, msg: `「何を畏れておるのだ！　公方何するものぞ！」` },
            { type: 'dialog', leftName: args.masakatsuName, leftFace: args.masakatsuFace, msg: `「おい……その言葉は……」` },
            { type: 'dialog', leftName: args.nagayasuName, leftFace: args.nagayasuFace, msg: `「まあ待て、${args.masakatsuTitle}。おぬしの申すことはわかる」` },
            { type: 'dialog', leftName: args.nagayasuName, leftFace: args.nagayasuFace, msg: `「しかし、公方が我らにとって邪魔な存在であることは紛れもない事実じゃ。そうであろう？」` },
            { type: 'dialog', leftName: args.masakatsuName, leftFace: args.masakatsuFace, msg: `「むぅ……」` },
            { type: 'dialog', leftName: args.tomomichiName, leftFace: args.tomomichiFace, msg: `「左様。早う対処せねば、増長するばかりであるぞ」` },
            { type: 'dialog', leftName: args.nagayasuName, leftFace: args.nagayasuFace, msg: `「そうじゃ。であるならば、我らの取るべき道は一つであろう」` },
            { type: 'dialog', leftName: args.masakatsuName, leftFace: args.masakatsuFace, msg: `「……如何するつもりじゃ？」` },
            { type: 'dialog', leftName: args.tomomichiName, leftFace: args.tomomichiFace, msg: `「ちょうどよい御方がおるではないか。あれに全て押し付けてしまえばよい」` },
            ...
            { type: 'log', msg: `${args.yoshiteruGivenName}は自ら政務の採決を行い、その政治的地位を固めていった。` },
    ...
    eiroku_no_hen_part2: function(args) {
        return [
            ...
            { type: 'log', msg: `昼を迎える頃、${args.yoshiteruGivenName}はついに討たれた。` },
    ...
    eiroku_no_hen_part3: function(args) {
        return [
            ...
            { type: 'log', msg: `この日の夕刻、焼け跡には激しい夕立の雨が降り注いだ。` }
        ];
    },
    ...
    shogun_protection_1: function(args) {
        let messages = [
            ...
            { type: 'dialog', leftName: args.fujitakaName, leftFace: args.fujitakaFace, msg: `「なれど、左馬頭様は時折、遠い目をなされるのじゃ」` },
            ...
            { type: 'dialog', leftName: args.asakuraName, leftFace: args.asakuraFace, msg: `「近頃、北の方は何かと賑やかな様子にございまするが、ここ一乗谷は静かで過ごしやすい土地にございます」` },
            { type: 'dialog', leftName: args.asakuraName, leftFace: args.asakuraFace, msg: `「冬には深く美しい雪が見られまする。左馬頭様のお心の慰みにもなりましょう」` },
            { type: 'dialog', leftName: args.fujitakaName, leftFace: args.fujitakaFace, msg: `「……」` },
            { type: 'dialog', leftName: args.asakuraName, leftFace: args.asakuraFace, msg: `「ここに住む者としては、雪が深うなりましたら、移動には不便なのがちと厄介でございますが。帰ることすらままなりませぬゆえ」` },
