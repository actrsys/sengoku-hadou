...
window.EventTextManager = {
    ...
    shogun_protection_1: function(args) {
        return [
            ...
            { type: 'dialog', leftName: args.asakuraName, leftFace: args.asakuraFace, msg: `「近頃は何かと賑やかな加州と比べてましても、越前は遥かに静かで過ごしやすい土地にございます」` },
            { type: 'dialog', leftName: args.asakuraName, leftFace: args.asakuraFace, msg: `「冬には美しい雪が見られまする。左馬頭様のお心の慰みにもなりましょう」` },
