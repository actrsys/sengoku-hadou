...
window.EventTextManager = {
    ...
    kawanakajima_event: function(args) {
        return [
            ...
            { type: 'dialog', leftName: args.shingenName, leftFace: args.shingenFace, msg: `「別働隊一万二千を${args.toratsunaFamilyName}・${args.nobufusaFamilyName}の両名に預ける。わしは八幡原に鶴翼の陣を敷き、${args.kenshinGivenName}を待ち受ける。よいな？」` },
            ...
            { type: 'log', msg: `一方その頃、もぬけの空となった妻女山に攻め込んだ${args.takedaFamilyName}軍の別働隊は異変に気付き、急ぎ八幡原へと軍を進めていた。` },
            { type: 'log', msg: `しかし、その行く手に${args.uesugiFamilyName}軍のしんがりを務める${args.kagemochiName}が立ちふさがった。` },
            { type: 'log', msg: `${args.kagemochiName}勢は大軍を受け止めながら見事な撤退戦を展開した。` },
