...
window.EventTextManager = {
    ...
    kawanakajima_event: function(args) {
        return [
            ...
            { type: 'log', msg: `両軍は千曲川を挟んで睨み合い、膠着状態が続いた。${args.takedaFamilyName}軍は戦線硬直を避けるため、八幡原を横断して海津城に入城した。` },
            { type: 'log', msg: `しかし、海津城への入城後も膠着状態は続き、士気の低下を恐れた${args.takedaFamilyName}の重臣は${args.uesugiFamilyName}軍との決戦を主張した。` },
            { type: 'log', msg: `海津城・${args.takedaFamilyName}本陣。` },
            { type: 'dialog', leftName: args.nobushigeName, leftFace: args.nobushigeFace, msg: `「兄上。このままでは兵の士気が下がる一方です。ここは打って出て、決戦を仕掛けるべきかと。兵数では我らが上回っておりまする」` },
            { type: 'dialog', rightName: args.shingenName, rightFace: args.shingenFace, msg: `「いかんぞ、${args.nobushigeGivenName}。${args.kenshinGivenName}ほどの戦巧者をわしは知らぬ。侮ってよい相手ではないのだ」` },
            { type: 'dialog', leftName: args.kansukeName, leftFace: args.kansukeFace, msg: `「しからば、拙者に一計がござりまする」` },
            { type: 'dialog', rightName: args.shingenName, rightFace: args.shingenFace, msg: `「申してみよ、勘助」` },
            ...
            { type: 'dialog', rightName: args.nobushigeName, rightFace: args.nobushigeFace, msg: `「おお……」` },
            { type: 'dialog', leftName: args.kansukeName, leftFace: args.kansukeFace, msg: `「名付けて、啄木鳥」` },
            { type: 'dialog', rightName: args.shingenName, rightFace: args.shingenFace, msg: `「……なるほど。啄木鳥が木を叩いて虫を飛び立たせるが如く、驚いて飛び出した虫を喰らう、ということか」` },
            { type: 'dialog', leftName: args.kansukeName, leftFace: args.kansukeFace, msg: `「はっ、ご明察の通りにございまする」` },
            { type: 'dialog', rightName: args.nobushigeName, rightFace: args.nobushigeFace, msg: `「兄上。やりましょう」` },
            { type: 'dialog', rightName: args.shingenName, rightFace: args.shingenFace, msg: `「……よし、やろう」` },
            { type: 'dialog', rightName: args.shingenName, rightFace: args.shingenFace, msg: `「別働隊一万二千を${args.toratsunaFamilyName}・${args.nobufusaFamilyName}の両名に預ける。わしは八幡原に鶴翼の陣を敷き、${args.kenshinGivenName}を待ち受ける。よいな？」` },
            { type: 'dialog', leftName: args.kansukeName, leftFace: args.kansukeFace, msg: `「ははっ！ 御意にござりまする！」` },
            { type: 'log', msg: `一方、妻女山の${args.uesugiFamilyName}本陣。` },
            { type: 'dialog', leftName: args.kageieName, leftFace: args.kageieFace, msg: `「殿、海津城の炊煙がいつになく増しているとのことです」` },
            { type: 'dialog', rightName: args.kenshinName, rightFace: args.kenshinFace, msg: `「${args.shingenGivenName}め、逸ったな！ 目端の利く者に城を見張らせておったかいがあったわ！」` },
            { type: 'dialog', leftName: args.kageieName, leftFace: args.kageieFace, msg: `「殿、どうなさいますか？」` },
            { type: 'dialog', rightName: args.kenshinName, rightFace: args.kenshinFace, msg: `「ふん、夜陰に乗じて我々の背後を突くつもりであろう」` },
            { type: 'dialog', rightName: args.kenshinName, rightFace: args.kenshinFace, msg: `「我らはすみやかに妻女山を下り、川を渡る。そして手薄となるであろう、${args.takedaFamilyName}本隊に急襲を仕掛けるのじゃ」` },
            { type: 'dialog', rightName: args.kenshinName, rightFace: args.kenshinFace, msg: `「${args.kagemochiFamilyName}殿に兵一千を預ける。これをもって${args.takedaFamilyName}軍の別働隊に備え、渡河を阻止されたし」` },
            { type: 'dialog', leftName: args.kagemochiName, leftFace: args.kagemochiFace, msg: `「はっ！」` },
            { type: 'dialog', rightName: args.kenshinName, rightFace: args.kenshinFace, msg: `「これより、一切の物音を立てることを禁ずる。粛々と川を渡るべし。兵にも徹底させるのじゃ」` },
            { type: 'dialog', leftName: args.kageieName, leftFace: args.kageieFace, msg: `「ははーっ」` },
            { type: 'dialog', rightName: args.kenshinName, rightFace: args.kenshinFace, msg: `「ふふ……目にものを見せてくれようぞ、${args.shingenGivenName}」` },
            ...
            { type: 'dialog', rightName: args.shingenName, rightFace: args.shingenFace, msg: `「おのれ、してやられたわ！ 直ちに迎撃の準備をせよ！」` },
            { type: 'dialog', leftName: args.nobushigeName, leftFace: args.nobushigeFace, msg: `「だ、駄目です兄上。兵どもが動揺して……」` },
            { type: 'dialog', rightName: args.shingenName, rightFace: args.shingenFace, msg: `「ええい、なんということだ」` },
            { type: 'log', msg: `${args.uesugiFamilyName}軍は${args.kageieName}軍を先頭に、車懸りの陣で猛然と襲いかかった。凄まじい波状攻撃を浴びて${args.takedaFamilyName}軍は防戦一方となり、危機的状況に陥った。` },
            { type: 'log', msg: `乱戦の中、${args.nobushigeName}、${args.kansukeName}といった重臣らが次々と討死していった。` },
            { type: 'log', msg: `そして、手薄となった${args.shingenGivenName}の本陣に、白手拭いで頭を包み、放生月毛に跨った騎馬武者が、名刀・小豆長光を振り上げて斬り込んだ。` },
            { type: 'log', msg: `${args.kenshinName}である。` },
            { type: 'dialog', rightName: args.kenshinName, rightFace: args.kenshinFace, msg: `「${args.shingenGivenName}、覚悟っ！」` },
            ...
            { type: 'log', msg: `側近が槍で馬を突くと、馬は驚いて駆け出し、${args.kenshinGivenName}はその場を去っていった。` },
            { type: 'log', msg: `一方、もぬけの空となった妻女山に攻め込んだ${args.takedaFamilyName}軍の別働隊は異変に気付き、急ぎ八幡原へと軍を進めていた。` },
            { type: 'log', msg: `しかし、その行く手に${args.uesugiFamilyName}軍のしんがりを務める${args.kagemochiName}が立ちふさがった。` },
            { type: 'log', msg: `${args.kagemochiName}勢は大軍を受け止めながら、見事な撤退戦を展開した。` },
            { type: 'log', msg: `しかし昼前になって、ついに${args.takedaFamilyName}軍の別働隊が八幡原に到着。挟撃される形となった${args.uesugiFamilyName}軍は兵を引き、越後へと撤退していった。` },
            { type: 'log', msg: `この戦による死者は、${args.uesugiFamilyName}方が三千余、${args.takedaFamilyName}方は四千余。互いに多数の犠牲を出す未曾有の大いくさとなった。` },
            { type: 'log', msg: `川中島での両者の激突の報は、瞬く間に日ノ本全土へと知れ渡った。` }
        ];
    }
};