...
window.EventTextManager = {
    ...
    eiroku_no_hen_part1: function(args) {
        return [
            ...
            { type: 'dialog', leftName: args.nagayasuName, leftFace: args.nagayasuFace, msg: `「まあ待て、${args.masakatsuGivenName}。おぬしの言いたいことはわかる。」` },
            { type: 'dialog', leftName: args.nagayasuName, leftFace: args.nagayasuFace, msg: `「しかし、公方が我らにとって邪魔な存在であることは紛れもない事実じゃ」` },
            ...
            { type: 'dialog', leftName: args.masakatsuName, leftFace: args.masakatsuFace, msg: `「……如何するつもりだ？」` },
            { type: 'dialog', leftName: args.tomomichiName, leftFace: args.tomomichiFace, msg: `「ちょうどよい男がおるではないか。あれに全て押し付けてしまえばよい」` },
            { type: 'dialog', leftName: args.nagayasuName, leftFace: args.nagayasuFace, msg: `「左様。あれはわしらの言葉を疑いもせぬじゃろう」` },
