...
window.EventTextManager = {
    ...
    okehazama_part1: function(args) {
        return [
            ...
            { type: 'dialog', leftName: args.juushinAName, leftFace: args.juushinAFace, msg: `「${args.nobunagaName}様、${args.imagawaClanName}軍は総勢二万五千の大軍でござる。かくなる上は、降伏するしかありませぬ。」` },
            { type: 'dialog', leftName: args.juushinBName, leftFace: args.juushinBFace, msg: `「馬鹿なことを申すな！\n一戦交えずして降伏など武士の名折れにござる。」` },
            { type: 'dialog', leftName: args.juushinBName, leftFace: args.juushinBFace, msg: `「${args.nobunagaName}様、ここは籠城して援軍を待つべきかと。」` },
    ...
    okehazama_attack: function(args) {
        return [
            ...
            { type: 'log', msg: `${args.odaClanName}軍は豪雨に乗じて兵を進め、${args.yoshimotoName}の本隊に奇襲をかけた。勢いを得た${args.odaClanName}軍は、とうとう${args.yoshimotoGivenName}を追い詰めた。` },
            { type: 'log', msg: `${args.yoshimotoName}は自らも奮戦したが、${args.odaClanName}軍の猛攻により、次々と兵は討ち取られていった。` },
