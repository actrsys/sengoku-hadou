...
window.GameEvents.push({
    ...
    checkCondition: function(game) {
        ...
        // 6. 松永久秀（ID: 1202004）が生存し、三好勢力に所属しているか、または自身が大名であるか
        const targetDaimyoIds = [1020014, 1020021];
        let isConditionMet = false;
        
        // まず、松永久秀が生きているか確認します
        if (!window.EventCheck.isAlive(game, 1202004)) return false;
...
window.GameEvents.push({
    ...
    checkCondition: function(game) {
        ...
        // 3. 松永久秀（ID: 1202004）が大名であるか確認します
        const hisahideDaimyo = window.EventCheck.getDaimyo(game, 1202004);
    ...
    execute: async function(game) {
        ...
        const hisahideDaimyo = game.getBusho(1202004);
...
window.GameEvents.push({
    ...
    checkCondition: function(game) {
        ...
        // 3. 松永長頼（ID: 1202006）が死亡しているか確認します
        // if (!window.EventCheck.isDead(game, 1202006)) return false;

        // 4. 松永久秀（ID: 1202004）が存在し、大名ではないことを確認します
        const hisahide = game.getBusho(1202004);
...
window.GameEvents.push({
    ...
    checkCondition: function(game) {
        ...
        // 3. 松永久秀（ID: 1202004）が大名であるか確認します
        const hisahide = window.EventCheck.getDaimyo(game, 1202004);
