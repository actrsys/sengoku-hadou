...
Object.assign(UIInfoManager.prototype, {
    ...
    _renderBushoSelector(actionType, targetId, extraData, onBack, scrollPos = 0) {
        ...
        if (['appoint','appoint_legion_leader','employ_target','appoint_gunshi','rumor_target_busho','headhunt_target','interview','interview_target','reward','war_general', 'kunishu_war_general', 'marriage_princess', 'marriage_kinsman', 'succession', 'arrange_marriage_busho'].includes(actionType)) isActionFree = true;
