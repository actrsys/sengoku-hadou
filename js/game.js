...
class GameSystem {
    ...
    static isProdCastle(c, itemType) {
        ...
        if (itemType === 'horse') {
            // 岩村城(4)、黒川城(61)、塩生城(62)、日野江城(157)、蠣崎城(191)、野辺地城(192)、八戸城(193)、三戸城(194)、花輪館(196)、白石城(206)、三春城(211)、須賀川城(212)、杉目城(214)、二本松城(215)、猪苗代城(216)
            if ([4, 61, 62, 157, 191, 192, 193, 194, 196, 206, 211, 212, 214, 215, 216].includes(c.id)) return true;
