...
class GameSystem {
    ...
    static toGradeHTML(val) {
        ...
        else if (val >= 66) { base = "B"; sub = "+"; cls = "rank-b"; } 
        else if (val >= 61) { base = "B"; sub = "";  cls = "rank-b"; }
        else if (val >= 51) { base = "C"; sub = "+"; cls = "rank-c"; } 
        else if (val >= 46) { base = "C"; sub = "";  cls = "rank-c"; }
...
class GameManager {
    ...
    async loadScenario(folder) {
        ...
        try {
            ...
            // ★追加：ゲーム開始時の年と月を、ゲーム本体にしっかり記憶させます！
    ...
    saveGameToFile() { 
        const data = { 
            year: this.year, 
            month: this.month, 
            startYear: this.startYear || window.MainParams.StartYear,
            startMonth: this.startMonth || window.MainParams.StartMonth,
