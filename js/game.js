...
class GameManager {
    ...
    async startMonth() { 
        ...
        this.castles.forEach(c => {
            ...
            // ★ここから追加：港拠点の交易収入ボーナス！
            //春日山城(ID2)、石山御坊(ID33)、松波城(ID72)、尾山御坊(ID74)、北庄城(ID76)、立花山城(ID148)、内城(ID169))、厳原城(ID174)、安濃津城(予定)、土崎港(予定)、十三湊(予定)
            const portCastleIds = [2, 33, 72, 74, 76, 148, 169, 174]; // 港拠点のIDリスト
            let portBonus = 0;
