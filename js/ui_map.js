...
Object.assign(UIManager.prototype, {
    ...
    renderMap() {
        ...
        const forceReverse = ["2-95", "17-24", "33-42", "38-102", "49-78", "56-102", "79-81", "153-155", "154-157", "169-171"]; // 例：["5-6"] と書くと5番と6番の城の道の曲がる向きが逆になります
        const forceNormalCurve = ["33-42", "126-155"]; // S字を強制的に「普通のカーブ」に戻すリストです
