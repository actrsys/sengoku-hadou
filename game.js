...
class UIManager {
    constructor(game) {
        ...
        this.marketRateDisplay = document.getElementById('market-rate'); // Add missing
        this.tradeTypeInfo = document.getElementById('trade-type-info'); // Add missing
    ...
    renderMap() {
        ...
        // Safely set market rate if element exists
