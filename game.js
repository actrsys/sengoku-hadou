...
fullContent:
/**
 * 戦国シミュレーションゲーム - シナリオ対応・バグ修正版
 */

/* --- Config & Data --- */
const CONFIG = {
    StartMonth: 1, // 年はシナリオによる
    ...
    Coef: {
        ...
        TrainingLdr: 2.0, TrainingStr: 1.0, MoraleLdr: 2.0, MoraleChm: 1.0, BaseTraining: 5, BaseMorale: 5
    },
    War: {
    ...
    Trade: { MinRate: 0.5, MaxRate: 3.0, Fluctuation: 0.2 }
};
...
// Fallback Data (もしファイル読み込みに失敗した場合の1560年データ)
const DEFAULT_CSV_CLANS = `id,name,color,leaderId
1,上杉家,#d32f2f,10001
2,武田家,#1976d2,20001
3,北条家,#fbc02d,30001
4,今川家,#7b1fa2,50001
5,斎藤家,#388e3c,50001
6,織田家,#212121,60001`.trim();

const DEFAULT_CSV_CASTLES = `id,name,ownerClan,x,y,castellanId,soldiers,gold,rice,kokudaka,commerce,defense,loyalty,population,training,morale
1,魚津城,1,1,0,10002,8000,3000,15000,900,600,800,800,20000,50,50
2,春日山城,1,2,0,10001,12000,6000,25000,1500,1000,1200,900,30000,60,60
15,新発田城,1,3,0,10007,9000,3500,16000,950,700,900,850,22000,50,50
3,稲葉山城,5,0,1,50001,11000,5000,20000,1400,1200,1100,700,28000,50,50
4,岩村城,5,1,1,50003,7000,2000,12000,700,500,900,600,15000,40,40
5,海津城,2,2,1,20002,9000,3500,16000,900,700,1000,800,20000,50,50
6,厩橋城,1,3,1,10003,8000,3000,14000,850,800,700,750,18000,50,50
7,清州城,6,0,2,60001,11000,5500,22000,1600,1500,1000,850,35000,60,60
8,飯田城,2,1,2,20005,7500,2500,13000,750,600,800,700,16000,50,50
9,躑躅ヶ崎館,2,2,2,20001,13000,7000,24000,1600,1200,1100,950,32000,70,70
10,河越城,3,3,2,30002,8500,3500,17000,1000,900,900,800,21000,50,50
11,名古屋城,6,0,3,60003,9000,4000,18000,1100,1400,850,800,24000,50,50
12,曳馬城,4,1,3,40002,8000,3000,15000,900,1000,800,700,19000,40,40
13,駿府城,4,2,3,40001,12000,9000,28000,1800,2000,1300,900,38000,30,30
14,小田原城,3,3,3,30001,15000,8000,30000,2000,1800,2000,950,40000,60,60
`.trim();

const DEFAULT_CSV_BUSHOS = `id,name,strength,politics,diplomacy,intelligence,charm,loyalty,clan,castleId,personality,ambition,affinity,leadership
10001,上杉謙信,100,60,55,85,99,100,1,2,aggressive,60,5,98
10002,柿崎景家,94,30,20,40,60,86,1,1,aggressive,40,6,84
10003,直江景綱,60,85,88,80,70,93,1,6,balanced,30,5,75
10004,宇佐美定満,68,60,70,92,60,86,1,2,conservative,30,4,87
10007,本庄繁長,88,40,30,60,50,26,1,15,aggressive,80,5,82
10008,甘粕景持,87,45,40,58,65,90,1,2,aggressive,40,4,83
10009,斎藤朝信,82,78,75,82,75,92,1,1,balanced,35,5,84
20001,武田信玄,88,95,90,96,98,100,2,9,balanced,95,65,100
20002,高坂昌信,74,82,75,86,80,93,2,5,conservative,40,66,88
20003,山県昌景,96,70,60,75,82,93,2,9,aggressive,50,64,94
20004,山本勘助,72,60,70,94,65,86,2,5,aggressive,40,65,85
20005,秋山信友,84,65,70,78,75,86,2,8,balanced,50,65,84
20006,馬場信春,88,68,60,83,80,95,2,9,balanced,30,65,93
20007,内藤昌豊,76,75,70,85,82,95,2,5,balanced,30,65,89
20008,真田幸隆,64,88,92,97,75,85,2,8,conservative,80,64,86
30001,北条氏康,88,98,85,90,94,100,3,14,conservative,85,20,96
30002,北条氏政,65,72,60,68,75,86,3,10,conservative,60,20,76
30003,北条綱成,97,50,40,65,85,100,3,14,aggressive,40,19,94
30004,北条氏照,85,72,75,68,78,90,3,14,aggressive,50,20,86
30005,北条氏邦,84,68,65,60,70,88,3,10,aggressive,45,19,83
30006,風魔小太郎,96,20,10,85,40,90,3,14,aggressive,20,21,86
40001,今川義元,68,92,90,85,90,100,4,13,conservative,90,30,95
40002,朝比奈泰朝,83,50,50,50,60,86,4,12,balanced,40,30,79
40003,太原雪斎,60,96,98,98,85,100,4,13,conservative,50,29,94
40004,松平元康,86,94,90,92,96,70,4,12,conservative,100,44,99
40005,岡部元信,82,60,55,65,60,90,4,13,balanced,40,30,83
40006,井伊直虎,68,78,80,75,88,85,4,12,conservative,50,35,76
50001,斎藤義龍,89,60,50,65,60,40,5,3,conservative,90,35,85
50002,稲葉一鉄,84,75,60,78,70,46,5,3,balanced,60,38,81
50003,遠山景任,60,55,60,55,55,66,5,4,conservative,40,35,65
50004,竹中半兵衛,65,82,88,99,85,80,5,3,balanced,30,40,98
50005,安藤守就,68,70,65,75,60,60,5,3,conservative,60,38,73
50006,氏家卜全,75,65,60,70,55,60,5,3,balanced,60,38,77
60001,織田信長,87,100,95,95,99,100,6,7,aggressive,100,45,100
60002,柴田勝家,96,65,50,60,80,93,6,7,aggressive,70,44,93
60003,佐久間信盛,72,70,75,70,60,66,6,11,conservative,50,46,79
60004,木下藤吉郎,65,94,96,95,98,95,6,7,aggressive,100,45,96
60005,前田利家,92,65,60,60,85,95,6,7,aggressive,70,46,85
60006,丹羽長秀,76,85,88,82,84,98,6,7,balanced,50,45,86
60007,滝川一益,84,70,75,80,70,90,6,11,aggressive,60,44,91
90001,明智光秀,82,92,90,94,88,100,0,3,balanced,90,42,97
90002,上泉信綱,100,20,30,75,80,100,0,10,balanced,10,10,88
90003,前田慶次,99,20,30,65,90,100,0,7,aggressive,80,46,75
`.trim();

/* --- Data Manager --- */
class DataManager {
    static async loadAll(folderName) {
        // パス生成: ./data/{folderName}/...
        const path = `./data/${folderName}/`;
        
        const clans = await this.loadData(path + "clans.csv", DEFAULT_CSV_CLANS, Clan);
        const castles = await this.loadData(path + "castles.csv", DEFAULT_CSV_CASTLES, Castle);
        const bushos = await this.loadData(path + "warriors.csv", DEFAULT_CSV_BUSHOS, Busho);
        
        this.joinData(clans, castles, bushos);
        if (CONFIG.System.GenerateGenerics) this.generateGenericBushos(bushos, castles, clans);
    ...
    static generateGenericBushos(bushos, castles, clans) {
        let idCounter = 30000;
        clans.forEach(clan => {
            const clanCastles = castles.filter(c => c.ownerClan === clan.id); if(clanCastles.length === 0) return;
            for(let i=0; i<5; i++) {
...
class Busho {
    constructor(data) {
        ...
        this.isDaimyo = false; this.isGunshi = false; this.isCastellan = false; // Reset flags to rely on joinData
...
class GameSystem {
    ...
    static calcTraining(busho) { return Math.floor(CONFIG.Coef.BaseTraining + (busho.leadership * CONFIG.Coef.TrainingLdr + busho.strength * CONFIG.Coef.TrainingStr) / 10); }
    static calcSoldierCharity(busho) { return Math.floor(CONFIG.Coef.BaseMorale + (busho.leadership * CONFIG.Coef.MoraleLdr + busho.charm * CONFIG.Coef.MoraleChm) / 10); }
    ...
    static calcUnitStats(bushos) { if (!bushos || bushos.length === 0) return { ldr:30, str:30, int:30, charm:30 }; const sorted = [...bushos].sort((a,b) => b.leadership - a.leadership); const leader = sorted[0]; const subs = sorted.slice(1); let totalLdr = leader.leadership; let totalStr = leader.strength; let totalInt = leader.intelligence; subs.forEach(b => { totalLdr += b.leadership * 0.2; totalStr += b.strength * 0.2; totalInt += b.intelligence * 0.2; }); return { ldr: Math.floor(totalLdr), str: Math.floor(totalStr), int: Math.floor(totalInt), charm: leader.charm }; }
    static calcWarDamage(atkStats, defStats, atkSoldiers, defSoldiers, defWall, atkMorale, defTraining, type) {
        ...
        const atkPower = ((atkStats.ldr * 1.2) + (atkStats.str * 0.3) + (atkSoldiers * CONFIG.War.SoldierPower)) * (1.0 + moraleBonus);
        const defPower = ((defStats.ldr * 1.0) + (defStats.int * 0.5) + (defWall * CONFIG.War.WallDefense) + (defSoldiers * CONFIG.War.SoldierPower)) * (1.0 + trainingBonus);
        let multiplier = 1.0, soldierRate = 1.0, wallRate = 0.0, counterRisk = 1.0;
        switch(type) {
            case 'bow': multiplier = 0.6; wallRate = 0.0; counterRisk = 0.5; break;
            case 'siege': multiplier = 1.0; soldierRate = 0.05; wallRate = 3.0; counterRisk = 1.0; break;
            case 'charge': multiplier = 1.2; soldierRate = 1.0; wallRate = 0.5; counterRisk = 1.5; break;
        ...
        const ratio = atkPower / (atkPower + defPower + (type!=='siege'?0:0));
        let baseDmg = atkPower * ratio * multiplier * rand; baseDmg = Math.max(50, baseDmg);
    ...
    static calcIncite(busho) { const score = (busho.intelligence * 0.7) + (busho.strength * 0.3); const success = Math.random() < (score / 150); if(!success) return { success: false, val: 0 }; return { success: true, val: Math.floor(score * 2) }; }
    static calcRumor(busho, targetBusho) { const score = (busho.intelligence * 0.7) + (busho.strength * 0.3); const defScore = (targetBusho.intelligence * 0.5) + (targetBusho.loyalty * 0.5); const success = Math.random() < (score / (defScore + 50)); if(!success) return { success: false, val: 0 }; return { success: true, val: Math.floor(20 + Math.random()*20) }; }
    static calcScheme(atkBusho, defBusho, defCastleLoyalty) { const atkInt = atkBusho.intelligence; const defInt = defBusho ? defBusho.intelligence : 30; const successRate = (atkInt / (defInt + 20)) * 0.6; if (Math.random() > successRate) return { success: false, damage: 0 }; const loyaltyBonus = (1000 - defCastleLoyalty) / 500; return { success: true, damage: Math.floor(atkInt * 10 * (1.0 + loyaltyBonus)) }; }
    ...
    static calcEmploymentSuccess(recruiter, target, recruiterClanPower, targetClanPower) { if (target.clan !== 0 && target.ambition > 70 && recruiterClanPower < targetClanPower * 0.7) return false; const affDiff = this.calcAffinityDiff(recruiter.affinity, target.affinity); let affBonus = (affDiff < 10) ? CONFIG.Employ.AffinityBonus : (affDiff < 25) ? CONFIG.Employ.AffinityBonus/2 : (affDiff > 40) ? -10 : 0; const resistance = target.clan === 0 ? target.ambition : target.loyalty * 1.5; return ((recruiter.charm + affBonus) * (Math.random() + 0.5)) > resistance; }
...
class UIManager {
    constructor(game) {
        ...
        this.selectorHeader = document.querySelector('.selector-content .busho-grid-header'); 
        ...
        this.scenarioScreen = document.getElementById('scenario-screen');
        ...
        const backBtn = document.querySelector('#selector-modal .btn-secondary'); if(backBtn) backBtn.onclick = () => this.closeSelector();
    }
    // ... Log, Cutin, etc. (No changes) ...
    ...
    renderMap() {
        ...
        this.game.castles.forEach(c => {
            ...
            if (!this.game.isProcessingAI) {
                if (isSelectionMode) { if (this.game.validTargets.includes(c)) { el.classList.add('selectable-target'); el.onclick = () => this.game.resolveMapSelection(c); } else { el.style.opacity = '0.4'; } } else { el.onclick = () => this.showCastleInfo(c); }
    ...
    // ... Command Menu ...
    renderCommandMenu() { /* Same as previous response, keeping it fully implemented */ this.cmdArea.innerHTML = ''; const createBtn = (label, cls, onClick) => { const btn = document.createElement('button'); btn.className = `cmd-btn ${cls || ''}`; btn.textContent = label; btn.onclick = onClick; this.cmdArea.appendChild(btn); }; if (this.menuState === 'MAIN') { createBtn("開発", "category", () => { this.menuState = 'DEVELOP'; this.renderCommandMenu(); }); createBtn("軍事", "category", () => { this.menuState = 'MILITARY'; this.renderCommandMenu(); }); createBtn("外交", "category", () => { this.menuState = 'DIPLOMACY'; this.renderCommandMenu(); }); createBtn("調略", "category", () => { this.menuState = 'STRATEGY'; this.renderCommandMenu(); }); createBtn("人事", "category", () => { this.menuState = 'PERSONNEL'; this.renderCommandMenu(); }); createBtn("機能", "category", () => { this.menuState = 'SYSTEM'; this.renderCommandMenu(); }); createBtn("終了", "finish", () => this.game.finishTurn()); } else if (this.menuState === 'DEVELOP') { createBtn("石高開発", "", () => this.openBushoSelector('farm')); createBtn("商業開発", "", () => this.openBushoSelector('commerce')); createBtn("施し", "", () => this.openBushoSelector('charity')); createBtn("戻る", "back", () => { this.menuState = 'MAIN'; this.renderCommandMenu(); }); } else if (this.menuState === 'MILITARY') { createBtn("出陣", "", () => this.game.enterMapSelection('war')); createBtn("徴兵", "", () => this.openBushoSelector('draft')); createBtn("修復", "", () => this.openBushoSelector('repair')); createBtn("訓練", "", () => this.openBushoSelector('training')); createBtn("兵施し", "", () => this.openBushoSelector('soldier_charity')); createBtn("輸送", "", () => this.game.enterMapSelection('transport')); createBtn("戻る", "back", () => { this.menuState = 'MAIN'; this.renderCommandMenu(); }); } else if (this.menuState === 'STRATEGY') { createBtn("調査", "", () => this.game.enterMapSelection('investigate')); createBtn("扇動", "", () => this.game.enterMapSelection('incite')); createBtn("流言", "", () => this.game.enterMapSelection('rumor')); createBtn("兵糧購入", "", () => this.openQuantitySelector('buy_rice')); createBtn("兵糧売却", "", () => this.openQuantitySelector('sell_rice')); createBtn("戻る", "back", () => { this.menuState = 'MAIN'; this.renderCommandMenu(); }); } else if (this.menuState === 'DIPLOMACY') { createBtn("親善", "", () => this.game.enterMapSelection('goodwill')); createBtn("同盟", "", () => this.game.enterMapSelection('alliance')); createBtn("同盟解消", "", () => this.game.enterMapSelection('break_alliance')); createBtn("戻る", "back", () => { this.menuState = 'MAIN'; this.renderCommandMenu(); }); } else if (this.menuState === 'INFO') { createBtn("調査", "", () => this.game.enterMapSelection('investigate')); createBtn("戻る", "back", () => { this.menuState = 'MAIN'; this.renderCommandMenu(); }); } else if (this.menuState === 'PERSONNEL') { createBtn("移動", "", () => this.game.enterMapSelection('move')); createBtn("登用", "", () => this.openBushoSelector('employ_target')); const isDaimyoHere = this.game.getCastleBushos(this.currentCastle.id).some(b => b.isDaimyo); if (!isDaimyoHere) createBtn("城主任命", "", () => this.openBushoSelector('appoint', null, {allowDone: true})); createBtn("軍師任命", "", () => this.openBushoSelector('appoint_gunshi', null, {allowDone: true})); createBtn("追放", "", () => this.openBushoSelector('banish')); createBtn("戻る", "back", () => { this.menuState = 'MAIN'; this.renderCommandMenu(); }); } else if (this.menuState === 'SYSTEM') { createBtn("ファイル保存", "", () => window.GameApp.saveGameToFile()); createBtn("ファイル読込", "", () => document.getElementById('load-file-input').click()); createBtn("戻る", "back", () => { this.menuState = 'MAIN'; this.renderCommandMenu(); }); } }
    ...
    openBushoSelector(actionType, targetId = null, extraData = null) {
        ...
        if (actionType === 'appoint_gunshi') { bushos = this.game.bushos.filter(b => b.clan === this.game.playerClanId && !b.isDaimyo && !b.isCastellan && b.status !== 'ronin' && b.status !== 'dead'); infoHtml = "<div>軍師に任命する武将を選択してください</div>"; sortKey = 'intelligence'; sortLabel = '知略'; } 
        ...
        bushos.forEach(b => {
            ...
            if(isSelectable) { 
                // Fix: Improve click handling to ensure selection works on row click
                div.onclick = (e) => { 
                    if(e.target.tagName !== 'INPUT') {
                        const inp = div.querySelector('input');
                        inp.checked = true; // Force check
                    }
                    updateContextCost(); 
                }; 
            }
        ...
        this.selectorConfirmBtn.onclick = () => {
            ...
            if (inputs.length === 0) { alert("武将を選択してください"); return; } // Fix: Feedback if empty
    ...
    openQuantitySelector(type, data, targetId) { /* ... Same ... */
        ...
        if (type === 'draft') {
            ...
            document.getElementById('quantity-title').textContent = "贈与金指定"; inputs.gold = createSlider("金", "gold", c.gold, CONFIG.Diplomacy.GoodwillCost);
            this.quantityConfirmBtn.onclick = () => { const val = parseInt(inputs.gold.num.value); if(val < CONFIG.Diplomacy.GoodwillCost) { alert("金が足りません"); return; } this.quantityModal.classList.add('hidden'); this.showGunshiAdvice({ type: 'goodwill' }, () => this.game.executeDiplomacy(data[0], targetId, 'goodwill', val)); };
        } else if (type === 'war') {
...
class GameManager {
    ...
    // Fix: Show Scenario Selection first
    boot() {
        document.getElementById('title-screen').classList.add('hidden');
        this.ui.showScenarioSelection(SCENARIOS, async (folder) => {
            this.currentScenarioFolder = folder;
    ...
    startMonth() {
        this.marketRate = Math.max(CONFIG.Trade.MinRate, Math.min(CONFIG.Trade.MaxRate, this.marketRate * (0.9 + Math.random()*0.2)));
    ...
    // ... Ronin, Optimize, ProcessTurn, FinishTurn, EndMonth ...
    ...
    processTurn() {
        ...
        const castle = this.turnQueue[this.currentIndex]; this.ui.renderMap();
        if (castle.ownerClan === this.playerClanId) {
            ...
            // this.ui.log(`【${castle.name}】(他国) 思考中...`); // Log spam reduction
            document.getElementById('control-panel').classList.add('hidden');
            setTimeout(() => this.execAI(castle), 400); // Speed up AI
        }
    }
    ...
    execAI(castle) {
        try {
            ...
            if (castellan && !castellan.isActionDone) {
                ...
                if(validEnemies.length > 0 && castle.soldiers > 3000) { this.startWar(castle, validEnemies[0], [castellan], Math.floor(castle.soldiers*0.5)); } 
                else {
                     if(castle.gold > 500) {
                         // Simple AI Logic
    ...
    startWar(atkCastle, defCastle, atkBushos, atkSoldierCount) {
        try {
            ...
            // Fix: If player is NOT involved, skip the cutin delay loop to prevent "uncontrollable" feeling
            if (isPlayerInvolved) {
                this.ui.showCutin(`${atkClan.name}軍の${atkGeneral}が\n${defCastle.name}に攻め込みました！`);
                setTimeout(() => {
                    document.getElementById('war-modal').classList.remove('hidden'); document.getElementById('war-log').innerHTML = ''; this.ui.log(`★ ${atkCastle.name}が出陣(兵${atkSoldierCount})！ ${defCastle.name}へ攻撃！`); this.updateWarUI(); this.processWarRound();
                }, 1500);
            } else {
                this.ui.log(`[合戦] ${atkCastle.name} vs ${defCastle.name} (自動決着)`);
                this.resolveAutoWar();
            }
        } catch(e) { console.error("StartWar:", e); this.finishTurn(); }
    }
    resolveAutoWar() { try { const s = this.warState; while(s.round <= 10 && s.attacker.soldiers > 0 && s.defender.soldiers > 0 && s.defender.defense > 0) { this.resolveWarAction('charge'); if (s.attacker.soldiers <= 0 || s.defender.soldiers <= 0) break; } this.endWar(s.defender.soldiers <= 0 || s.defender.defense <= 0); } catch(e) { console.error(e); this.endWar(false); } }
    ...
    endWar(attackerWon, defenderRetreated = false) { /* Same as previous */ const s = this.warState; s.active = false; if (s.isPlayerInvolved) document.getElementById('war-modal').classList.add('hidden'); const isShortWar = s.round < CONFIG.War.RetreatTurnLimit; const recoveryRate = isShortWar ? CONFIG.War.RetreatRecovery : CONFIG.War.WoundedRecovery; s.attacker.soldiers += Math.floor(s.deadSoldiers.attacker * recoveryRate); s.defender.soldiers += Math.floor(s.deadSoldiers.defender * recoveryRate); if (attackerWon) { s.attacker.training = Math.min(120, s.attacker.training + 5); s.attacker.morale = Math.min(120, s.attacker.morale + 5); if (defenderRetreated) { const retreatCastle = GameSystem.getRetreatCastle(s.defender, this.castles); const defCastellan = this.getBusho(s.defender.castellanId); if (retreatCastle && defCastellan) { retreatCastle.soldiers += s.defender.soldiers; s.defender.samuraiIds = s.defender.samuraiIds.filter(id => id !== defCastellan.id); retreatCastle.samuraiIds.push(defCastellan.id); defCastellan.castleId = retreatCastle.id; defCastellan.isCastellan = false; } } else { this.processCaptures(s.defender, s.attacker.ownerClan); } s.defender.ownerClan = s.attacker.ownerClan; s.defender.soldiers = s.attacker.soldiers; s.defender.investigatedUntil = 0; s.atkBushos.forEach((b, idx) => { const srcC = this.getCastle(s.sourceCastle.id); srcC.samuraiIds = srcC.samuraiIds.filter(id => id !== b.id); b.castleId = s.defender.id; s.defender.samuraiIds.push(b.id); if(idx === 0) { b.isCastellan = true; s.defender.castellanId = b.id; } else b.isCastellan = false; }); } else { const srcC = this.getCastle(s.sourceCastle.id); srcC.soldiers += s.attacker.soldiers; } if (s.attacker.ownerClan !== this.playerClanId) this.finishTurn(); else { this.ui.renderCommandMenu(); this.ui.renderMap(); } }
